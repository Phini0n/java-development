...
import com.pluralsight.NortwindTradersSpringBoot.dao.impl.SimpleProductDAO;
...
public class NortwindApplication implements CommandLineRunner {
    @Override
    public void run(String... args) throws Exception {
            ApplicationContext context = SpringApplication.run(NortwindTradersSpringBootApplication.class, args);
